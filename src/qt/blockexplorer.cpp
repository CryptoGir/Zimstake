...
{
    if(Height > pindexBest->nHeight) { return "e6c7701ab35b5e2df5b0452eb1e2c7e9d9658e1248b15ad9f85f47d44ad62303"; }
    if(Height < 0) { return "e6c7701ab35b5e2df5b0452eb1e2c7e9d9658e1248b15ad9f85f47d44ad62303"; }
    int desiredheight;
...
{    
    if(block)
    {
        ...
        ui->pawBox->setText(QPawrate + " GH/s");
    } 
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " ZS");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " ZS");
    }
}
